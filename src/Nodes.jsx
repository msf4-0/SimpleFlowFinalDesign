...
function OutputImageNode({ data, isConnectable }) {
  ...
  return (
    <div id="node" className="output-image-node">
      <p id={"nodelabel_" + ids[0]} className="nodelabel">
        Output Image
      </p>
      <Handle
        className="handle"
...
function CameraVideoInput({ data, isConnectable }) {
  ...
  if (document.getElementById("cont_" + "node_" + ids[0])) {
    if (
      document.getElementById("cont_" + "node_" + ids[0]).style.visibility ==
      "visible"
    ) {
  ...
  function toggleexpand() {
    if (data["expandtoggle"]) {
      ...
      document.getElementById("node_" + ids[0]).className =
...
function CustomNode({ data, isConnectable }) {
  ...
  if (document.getElementById("cont_" + "node_" + ids[0] + "_" + 0)) {
    if (
      document.getElementById("cont_" + "node_" + ids[0] + "_" + 0).style
        .visibility == "visible"
    ) {
      data["expandtoggle"] = false;
    }
      ...
      for (let i = 0; i < Object.keys(data["datamethods"]).length; i++) {
        ...
        if (!document.getElementById("cont_" + "node_" + ids[0] + "_" + i)) {
          let func = function () {
            ...
            cont.className = "cont";
            if (
              !document.getElementById("cont_" + "node_" + ids[0] + "_" + i)
            ) {
              document.getElementById("node_" + ids[0]).append(cont);
            }
            var newel = document.createElement("p");
            ...
            if (guidebook[data["datamethods"][i][0]]["element"] == "button") {
              newel = document.createElement(
                guidebook[data["datamethods"][i][0]]["element"]
              );
              let func = function () {
                try {
                  ...
                  fileUploaded(
                    data["datamethods"][i][3],
                    data["datamethods"][i][1]
                  );
                } catch (error) {
                  fileUploaded(
                    data["datamethods"][i][2],
                    data["datamethods"][i][1]
                  );
                }
              };
              ...
              guidebook[data["datamethods"][i][0]]["element"] == "select"
            ) {
              newel = document.createElement("select");
              newel.id = data["datamethods"][i][1] + "_" + ids[0];
              newel.className = "defaultselect";
              ...
              if (Array.isArray(data["datamethods"][i][2])) {
                newel = document.createElement("option");
                newel.id =
                  "select_" + data["datamethods"][i][2] + "_option_" + ids[0];
                newel.value = "select";
                newel.innerHTML = "Select";
                if (
                  !document.getElementById(
                  ...
                  document
                    .getElementById(data["datamethods"][i][1] + "_" + ids[0])
                    .append(newel);
                }
                for (let j = 0; j < data["datamethods"][i][2].length; j++) {
                  ...
                  if (
                    !document.getElementById(
                      data["datamethods"][i][2][j] + "_option_" + ids[0]
                    )
                  ) {
                    document
                      .getElementById(data["datamethods"][i][1] + "_" + ids[0])
                ...
                let newel = document.createElement("option");
                newel.id =
                  "select_" + Object.keys(obj)[0] + "_option_" + ids[0];
                newel.value = "select";
                newel.innerHTML = "Select";
                if (
                  !document.getElementById(
                ...
                for (let j = 0; j < obj[Object.keys(obj)[0]].length; j++) {
                  ...
                  if (
                    !document.getElementById(
                      obj[Object.keys(obj)[0]][j] + "_option_" + ids[0]
                    )
                  ) {
                    document
                      .getElementById(data["datamethods"][i][1] + "_" + ids[0])
              ...
              if (
                data["datamethods"][i][2] &&
                data["datamethods"][i][2] != "File" &&
                data["datamethods"][i][2] != "Folder"
              ) {
                cont.className = "cont";
                for (let j = 0; j < data["datamethods"][i][2].length; j++) {
                  newel = document.createElement(
                  ...
                  if (
                    !document.getElementById(
                      data["datamethods"][i][2][j] + "_" + ids[0]
                    )
                  ) {
                    cont.append(newel);
                  }
                  ...
                  newel.innerHTML = data["datamethods"][i][2][j];
                  newel.id =
                    "label_" + data["datamethods"][i][2][j] + "_" + ids[0];
  ...
  function dropdowndynamic(evt, d, b) {
    ...
    if (Array.isArray(data["datamethods"][b][3]) == false) {
        ...
        for (let n = 0; n < Object.keys(data["datamethods"]).length; n++) {
          if (data["datamethods"][n][1] == data["datamethods"][b][3]) {
            if (data["datamethods"][n][0] == "select") {
              let childs = document.getElementById(
                data["datamethods"][n][1] + "_" + ids[0]
              );
              ...
              if (
                !document.getElementById(
                  "select_" + evt.target.value + "_option_" + ids[0]
                )
              ) {
                document
                  .getElementById(data["datamethods"][b][3] + "_" + ids[0])
                  .append(newel);
              }
              for (let j = 0; j < obj[evt.target.value].length; j++) {
                ...
                if (
                  !document.getElementById(
                    obj[evt.target.value][j] + "_option_" + ids[0]
                  )
                ) {
                  document
                    .getElementById(data["datamethods"][b][3] + "_" + ids[0])
      ...
      for (let n1 = 0; n1 < els.length; n1++) {
        if (
          document.getElementById(data["datamethods"][b][3][n1] + "_" + ids[0])
        ) {
          for (let n = 0; n < Object.keys(data["datamethods"]).length; n++) {
  ...
  var func = function () {
    if (
      ...
      document.getElementById("nodelabel_" + ids[0]).innerHTML = data["inps"][
        "custom_node"
      ].replaceAll("_", " ");
    ...
    let clr = JSON.parse(data["color"])[data["innerHTML"]];
    document.getElementById("node_" + ids[0]).style.background =
      "radial-gradient(" + clr + "F9," + clr + "C9)";
  };
  ...
  func = function () {
    let clr = JSON.parse(data["color"])[data["innerHTML"]];
    document.getElementById("expand_" + ids[0]).style.borderBottomLeftRadius =
      "5%";
    document.getElementById("expand_" + ids[0]).style.borderBottomRightRadius =
      "5%";
  };
  intervalcreate("expand_" + ids[0], func);
...
export { SelectCamera, CameraVideoInput, StartNode, EndNode, CustomNode, Loop };
